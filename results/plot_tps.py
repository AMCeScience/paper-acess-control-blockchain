...
RBAC_IBFT_transactions_per_block = []
ACL_IBFT_transactions_per_block = []
...
for i in range(1,12):
    ...
    for key in RBAC_IBFT[i]["blocks"].keys():
        RBAC_IBFT_transactions_per_block.append(RBAC_IBFT[i]["blocks"][key]["transactions"])
        # baseline_get_gas_used_per_block.append(baseline_get["blocks"][key]["gasUsed"])
        # baseline_get_block_size.append(baseline_get["blocks"][key]["size"])
        RBAC_size += RBAC_IBFT[i]["blocks"][key]["size"]
        # baseline_get_size_growth.append(size_tmp)

for i in range(1,12):
    i = str(i)
    for key in ACL_IBFT[i]["blocks"].keys():
        ACL_IBFT_transactions_per_block.append(ACL_IBFT[i]["blocks"][key]["transactions"])
        # baseline_get_gas_used_per_block.append(baseline_get["blocks"][key]["gasUsed"])
        # baseline_get_block_size.append(baseline_get["blocks"][key]["size"])
        ACL_size += ACL_IBFT[i]["blocks"][key]["size"]
        # baseline_get_size_growth.append(size_tmp)
...
bp3 = ax.boxplot(request_IBFT_transactions_per_block, positions=[1], notch=True, widths=0.20,
                 patch_artist=True, boxprops=dict(facecolor="C0"))
# bp33 = ax.boxplot(verify_IBFT_transactions_per_block, positions=[2], notch=True, widths=0.20,
#                  patch_artist=True, boxprops=dict(facecolor="C1"))
bp333 = ax.boxplot(RBAC_IBFT_transactions_per_block, positions=[2], notch=True, widths=0.20,
                 patch_artist=True, boxprops=dict(facecolor="C1"))
bp3333 = ax.boxplot(ACL_IBFT_transactions_per_block, positions=[3], notch=True, widths=0.20,
                 patch_artist=True, boxprops=dict(facecolor="C2"))
print(len(RBAC_IBFT_transactions_per_block))
print(stats.mean(request_IBFT_transactions_per_block))
print(stats.mean(RBAC_IBFT_transactions_per_block))
print(stats.mean(ACL_IBFT_transactions_per_block))


print("Max and min values")
print(max(request_IBFT_transactions_per_block))
print(min(request_IBFT_transactions_per_block))
print(max(RBAC_IBFT_transactions_per_block))
print(min(RBAC_IBFT_transactions_per_block))
print(max(ACL_IBFT_transactions_per_block))
print(min(ACL_IBFT_transactions_per_block))
...
# plt.xticks([1,2,3,4], ['PEPSC\nRequestAccess', 'PEPSC\nVerifyAccess', 'RBACSC\nOnlyAdminCanDoThis', "ACLSC\nGetResourceMetada"], **csfont)
plt.xticks([1,2,3], ['PEPSC\nRequestAccess', 'RBACSC\nOnlyAdminCanDoThis', "ACLSC\nGetResourceMetadata"], **csfont)

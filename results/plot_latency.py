...
for i in range(1,12):
    i = str(i)
    for value in RBAC_IBFT[i]["latency"]:
        RBAC_IBFT_latency.append(value)        
    for value in ACL_IBFT[i]["latency"]:
        ACL_IBFT_latency.append(value)            
...
print("\n\RBAC / ACL")
print(stats.mean(RBAC_IBFT_latency))
print(stats.stdev(RBAC_IBFT_latency))

print(stats.mean(ACL_IBFT_latency))
print(stats.stdev(ACL_IBFT_latency))

    ...
    function policyCompliant(Policies.Policy memory loaded_policy, uint8 _attrs) public returns(bool){
        if ((bytes1(loaded_policy.policy) & bytes1(_attrs)) == bytes1(loaded_policy.policy)){
            if(loaded_policy.conventional_access){
                // 10 Contextual attributes
                if(attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender) && attributes_contract.getContextualAttribute(1, msg.sender, msg.sender)){

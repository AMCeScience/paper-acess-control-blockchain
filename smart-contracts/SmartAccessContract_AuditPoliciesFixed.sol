...
contract AuditTrail {
    ...
    function saveRequestLog(string memory _context_expression, uint8 _actions, string memory _outcome, string memory _agent, string memory _source_ip, string memory _country, string memory _city, address _processor_addr, uint _resource_id) public{

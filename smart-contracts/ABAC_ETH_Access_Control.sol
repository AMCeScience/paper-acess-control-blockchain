...
contract Cloud_Accesses {    
    ...
    function getGrantedAccess(string memory _public_key, uint256 _patient_uuid, string memory _access_type, string[] memory _actions, uint256 _access_timestamp) pure internal returns (bool) {    
        return true;
    }
}
